<?php get_header(); ?>
	...
	<main id="body-column" role="main" itemprop="mainContentOfPage" itemscope="itemscope" itemtype="http://schema.org/Blog">
		...
		<div class="row">
            ...
            <h1 itemprop="name" class="pagetitle"><?php single_cat_title(); ?></h1>
            <?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
            <h1 itemprop="name" class="pagetitle">Berichten met label: <?php single_tag_title(); ?></h1>
            <?php /* If this is a paged archive */ } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
            <h1 itemprop="name" class="pagetitle">Archief</h1>
            <?php } ?>
         </div>
		<section id="articles">
        	<div class="row">	
