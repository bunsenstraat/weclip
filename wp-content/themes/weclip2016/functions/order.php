    ...
    <header id="header" class="header patOrHor" role="banner" itemscope="itemscope" itemtype="http://schema.org/Organization">
        <div class="row contentRow">
            <h1 class="step_line">
                ...
                <span class="third-line"><?php if($_SESSION['steps']!=null){ echo $_SESSION['steps']; } else { echo 'NOG 4 STAPPEN TE GAAN';} ?></span>
            </h1>
        </div>
    </header>
...
unset($_SESSION['m']);
?>
<form action="<?php echo get_template_directory_uri();?>/functions/order-action.php" name="signup_form" id="signup_form" class="standard-form" method="post" enctype="multipart/form-data">
...
<input type="hidden" id="ann" value="anntal_<?php echo $name[$j]; ?>" name="category" />	
				...
				<span id="anntaaa<?php echo $j; ?>">ik wil gebruik maken van de probeerservice op de volgende voorwaarden: <span style="color: #EB4819;">&#8226; 3 productbeelden gratis &#8226; Geleverd met watermerk &#8226; Geen bijzondere bewerkingen mogelijk &#8226; Minimale afname van 25 beelden, indien tevreden uiteraard &#8226; De beelden bevatten watermerk</span>. (Voor een uitgebreide test met een langdurige samenwerking als doel, neem contact met ons op via <a href="mailto:info@weclip.nl">info@weclip.nl</a>)</span>
				<div class="hor_rule"></div>
...
<?php $radd = $_SESSION['delivery']; ?>				
    ...
    width: 313px;" >Ook als u spoed heeft zijn wij de goedkoopste. Tegen een kleine meerprijs van €0.25 per beeld leveren wij bestanden in lage resolutie tot 300 stuks binnen 24 uur, grotere aantallen of formaten gaan in overleg.<br /><span style="color: #EB4819;">Niet van toepassing op onze probeerservice</span></span></div><br />
