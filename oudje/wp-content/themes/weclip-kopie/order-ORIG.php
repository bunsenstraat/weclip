...
<input type="hidden" id="ann" value="anntal_<?php echo $name[$j]; ?>" name="category" />	
				...
				<ul>
					...
					<div class="tooltip_f_<?php echo $j; ?>">
						<div class="ttol_tipse">
							...
							<p>Een vrijstaand beeld lijkt vaak te zweven wat onnatuurlijk oogt. Wij kunnen een realistisch schaduw toevoegen om dit te voorkomen.</p>
							<div class="tool_img">
				...
				<ul>
					...
					<div class="ttol_tipse">
							<span class="tool_font">KRAAGJE</span>
